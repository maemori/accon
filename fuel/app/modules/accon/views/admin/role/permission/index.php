			...
			<div class="col-md-8 search-condition-input-box">
				...
				<div class="col-md-4">
					<span class="input-group search-condition-input">
						...
						<?php echo Form::select('role_id', isset($view_search['role_id']) ? $view_search['role_id'] : 0, $role_list, array('class' => 'col-md-4 form-control')); ?>
					</span>
				</div>
				<div class="col-md-8">
					<span class="input-group search-condition-input search-condition-input-end">
						<span class="input-group-addon">パーミッション</span>
						<?php echo Form::select('perms_id', isset($view_search['perms_id']) ? $view_search['perms_id'] : 0, $permission_list, array('class' => 'col-md-4 form-control')); ?>
					</span>
				</div>
			</div>
			<div class="col-md-4">
