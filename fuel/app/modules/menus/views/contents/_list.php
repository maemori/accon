					...
					<tr id="search-result">
						<td class="">
							<?php
								...
								echo Html::anchor('/menus/contents/parent?id='.$item->id,
									'<span title="親へ" class="glyphicon glyphicon glyphicon-arrow-left">',
									array('class' => 'btn btn-success', $root_children ? 'disabled' : ''));
								echo Html::anchor('/menus/contents/up?id='.$item->id,
									'<span title="上へ" class="glyphicon glyphicon glyphicon-arrow-up">',
									array('class' => 'btn btn-success', $first_child ? 'disabled' : ''));
								echo Html::anchor('/menus/contents/down?id='.$item->id,
									'<span title="下へ" class="glyphicon glyphicon glyphicon-arrow-down">',
									array('class' => 'btn btn-success', $last_child ? 'disabled' : ''));
								echo Html::anchor('/menus/contents/child?id='.$item->id,
