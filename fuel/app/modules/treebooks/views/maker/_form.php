...
<fieldset class="book-body">
	...
	<?php echo render('slug/_get_slug', array(ACTION_EDIT => $this->data[ACTION_EDIT])); ?>
	...
	<?php if ($this->data[ACTION_EDIT]): ?>
		<div class="form-group <?php echo !$val->error('content') ?: 'has-error' ?>">
			...
			<?php echo Form::textarea('content', Input::post('content', isset($model) ? $model->content : ''), array('rows' => '10', 'class' => 'col-md-4 form-control', 'placeholder' => 'content', $this->data[ACTION_EDIT] ? '' : 'disabled')); ?>
