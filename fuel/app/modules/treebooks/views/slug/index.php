			...
			<div class="col-md-8 search-condition-input-box">
				...
				<div class="col-md-4">
					<span class="input-group search-condition-input search-condition-input-end">
						<span class="input-group-addon">コード</span>
						<?php echo Form::input('code', isset($view_search['code']) ? $view_search['code'] : '', array('class' => 'form-control')); ?>
					</span>
				</div>
				<div class="col-md-8">
					<span class="input-group search-condition-input search-condition-input-end">
	...
	<div class="col-md-12">
		<?php if ($model): ?>
			<table class="table table-striped table-hover table-condensed" id="data_table">
				<thead>
				<tr>
					<th class="nowrap">ソート</th>
					<th class="nowrap">コード&nbsp;<span class="badge">ID</span></th>
				...
				<?php foreach ($model as $item): ?>
					<tr id="search-result">
						<td class="nowrap"><?php echo $item->sort; ?></td>
						<td class="nowrap"><?php echo $item->code.'&nbsp;<span class="badge">'.$item->id.'</span>'; ?></td>
						<td class="nowrap"><?php echo $item->name; ?></td>
...
<script>
	...
	$('#data_table').dataTable({
		...
		"aoColumnDefs": [{"bSortable": false, "aTargets": [4]}] // ソート除外
	});
</script>