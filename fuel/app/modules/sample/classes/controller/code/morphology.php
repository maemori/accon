 ...
 * @extends  Controller
 */
class Controller_Code_Morphology extends \Controller
{
	// サービスの説明
	const SERVICE_TITLE = 'めかぶ(MeCab)';
	const SERVICE_SUB_TITLE = 'PHPから利用とそのサンプルコード';
	const SERVICE_DESCRIPTION = '今、動いているソースをそのまま表示。';
	...
	public function action_index()
	{
		...
		$view->set_global('description', self::SERVICE_DESCRIPTION);
		...
		$view->content = \View::forge('morphology/code');
