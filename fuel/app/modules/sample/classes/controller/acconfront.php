 ...
 * @extends  Controller
 */
class Controller_Acconfront extends \Controller
{
	// サービスの説明
	const SERVICE_TITLE = 'Acconフロント機能実装方法';
	const SERVICE_SUB_TITLE = 'ブログ(フロント)';
	const SERVICE_DESCRIPTION = 'Acconモジュールを利用したブログ(フロント)の実装例。';
	...
	public function action_index()
	{
		...
		$view->content = \View::forge('acconfront/content');
