...
/etc/service/progress progress "[SETTING:DONE-1_of_6]_Install_python_library"

# Populate the database with initial basic data
cd /develop/workspace/taiga-back/
python3 manage.py migrate --noinput >> /develop/workspace/install.log
/etc/service/progress progress "[SETTING:DONE-2_of_6]_Data_initial_basic_data"
python3 manage.py loaddata initial_user >> /develop/workspace/install.log
/etc/service/progress progress "[SETTING:DONE-3_of_6]_Data_initial_user"
python3 manage.py loaddata initial_project_templates >> /develop/workspace/install.log
/etc/service/progress progress "[SETTING:DONE-4_of_6]_Data_initial_project_templates"
python3 manage.py compilemessages >> /develop/workspace/install.log
/etc/service/progress progress "[SETTING:DONE-5_of_6]_Data_compilemessages"
python3 manage.py collectstatic --noinput >> /develop/workspace/install.log
/etc/service/progress progress "[SETTING:DONE-6_of_6]_Data_completion_initialization"
